      ...
      <div className="mx-auto max-w-7xl px-6 items-center ">
        <div className="flex items-center justify-between border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          <div className="flex items-center justify-start  lg:w-0 lg:flex-1">
            <Link to="/">
              <img className="h-8 w-auto sm:h-10" src={logo} alt="gdsc-pec" />
            </Link>
            <span className="flex justify-start ml-3 text-xl lg:w-0 lg:flex-1">
              GDSC PEC{" "}
            </span>
          </div>
          ...
          <div className="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
            <div className="px-5 pt-5 pb-6">
              <div className="flex items-center justify-between">
                <div>
                  <img className="h-8 w-auto" src={logo} alt="gdsc-pec" />
                </div>
                <span className="flex justify-start ml-3 text-xl lg:w-0 lg:flex-1">
                  GDSC PEC{" "}
                </span>
